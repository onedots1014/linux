...
static int gpio_wl_reg_on =131; // WL_REG_ON is input pin of WLAN module
#ifdef CUSTOMER_OOB
static int gpio_wl_host_wake = 56; // WL_HOST_WAKE is output pin of WLAN module
#endif
